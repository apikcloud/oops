...
- Console scripts `oops-kb-build-global`, `oops-kb-build-project`, and `oops-refactor`. Use the `oops misc kb-build-global` and `oops addons refactor` group-attached forms.
