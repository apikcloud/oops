...
class VanillaPresenter(SimplePresenter[dict]):
    def to_human(self, result: "Result[dict]") -> SimpleSummaryLayout:
        ...
        metrics = StatGroup(
            ...
            values=[
                ...
                Stat(name="image", label="Odoo image", value=data.get("image") or "—"),
                Stat(name="synced_files", label="Synced files", value=len(data.get("synced_files") or [])),
                ...
                Stat(
                    name="orphan_submodules",
                    label="Orphan submodules removed",
                    value=len(data.get("orphan_submodules") or []),
                    highlight=bool(data.get("orphan_submodules")),
                ),
            ],
        )
    ...
    def to_machine(self, result: "Result[dict]") -> dict:
        ...
        return {
            ...
            "orphan_submodules": data.get("orphan_submodules") or [],
