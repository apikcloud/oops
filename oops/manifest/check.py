...
from oops.compat import Optional
from oops.helpers import str_to_list
from oops.io import find_addons_extended, find_manifests
from oops.parser import TypingCollector
from oops.render import human_readable
from oops.rules.__main__ import run_rules
...
def main(path: str, addons: Optional[str] = None):
    ...
    # path = "/home/aroy/dev/packages/oops"
